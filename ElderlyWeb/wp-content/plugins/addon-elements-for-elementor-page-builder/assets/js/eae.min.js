...
! function(e) {
    e(window).on("elementor/frontend/init", (function() {
        ...
        var u, m = elementorModules.frontend.handlers.Base;
        u = m.extend({
            ...
            var n = e.find(".eae-popup-wrapper").data("effect");
            $close_btn_type = e.find(".eae-popup-wrapper").data("close-button-type"), $close_btn = e.find(".eae-popup-wrapper").data("close-btn"), "icon" == $close_btn_type ? $close_btn_html = '<i class="eae-close ' + $close_btn + '"> </i>' : $close_btn_html = '<svg class="eae-close" style="-webkit-mask: url(' + $close_btn + "); mask: url(" + $close_btn + '); "></svg>';
            var i = e.find(".eae-popup-container"),
                r = i.attr("id");
            void 0 !== popupInstance[r] && null !== popupInstance[r] || (popupInstance[r] = i.find(".eae-popup-content").html(), i.find(".eae-popup-content").html("")), e.find(".eae-popup-wrapper .eae-popup-link").on("click", (function() {
                r = jQuery(this).data("id"), eae_popup_arr = jQuery(".eae-popup-container.eae-popup-" + r), eae_popup_arr.each((function(e, t) {
                    jQuery(t).find(".eae-popup-content").html(popupInstance[r])
                }))
                ...
                callbacks: {
                    beforeOpen: function() {
                        "" != n && (this.st.mainClass = "eae-popup eae-popup-" + e.find(".eae-popup-link").data("id") + " eae-wrap-" + e.find(".eae-popup-link").data("ctrl-id") + " mfp-" + n)
                    },
                    open: function() {
                        var a = e.find(".eae-popup-link").data("id"),
                            n = jQuery(".eae-popup-" + a + ".eae-popup-container .eae-modal-content");
                        t(n);
                        var i = n.find(".wpcf7-form");
                        i.length > 0 && i.each((function(e, t) {
                            wpcf7.init(t)
                        }))
                    },
                    afterClose: function() {
                        e.find(".eae-popup-container").find(".eae-popup-content").html("")
                    }
                }
            ...
            if (!e.hasClass("elementor-element-edit-mode"))
                if ("countdown" === s) {
                    ...
                    if ("" !== w) {
                        ...
                        n - h > 0 && (document.cookie = l + "=" + w + ";" + v + ";path=/")
                    } else {
                        temp_date = n, (y = new Date).setSeconds(y.getSeconds() + e.find(".eae-evergreen-wrapper").data("egtime")), n = y.getTime(), i(d, (new Date).getTime(), o);
                        var C = new Date;
            ...
            e.hasClass("elementor-element-edit-mode") && ("countdown" === s ? (y = new Date(n), n = y.getTime()) : ((y = new Date).setSeconds(y.getSeconds() + e.find(".eae-evergreen-wrapper").data("egtime")), n = y.getTime())), D(n).all > 1 && (a = setInterval((function() {
        ...
        })), elementorFrontend.hooks.addAction("frontend/element_ready/eae-content-switcher.skin1", s), elementorFrontend.hooks.addAction("frontend/element_ready/eae-content-switcher.skin2", s), elementorFrontend.hooks.addAction("frontend/element_ready/eae-content-switcher.skin3", d), elementorFrontend.hooks.addAction("frontend/element_ready/eae-content-switcher.skin4", d), elementorFrontend.hooks.addAction("frontend/element_ready/global", (function(e, t) {
            ...
            null !== swiperContainer && 0 === swiperContainer.length || new s(jQuery(swiperContainer), sliderData).then((e => {
                const t = e,
                    n = a.pauseOnHover;
                if ("yes" == a.loop && p(t, wid), "yes" == n && f(t, n, wid, a), void 0 !== a.autoplay) {
        ...
        })), elementorFrontend.hooks.addAction("frontend/element_ready/eae-chart.bar", l), elementorFrontend.hooks.addAction("frontend/element_ready/eae-chart.horizontalBar", l), elementorFrontend.hooks.addAction("frontend/element_ready/eae-chart.line", l), elementorFrontend.hooks.addAction("frontend/element_ready/eae-data-table.default", (function(e, t) {
